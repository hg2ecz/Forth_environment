...
#   f o r t h . p y
#
#   Original: https://www.openbookproject.net/py4fun/forth/forth.html
#
#   Improved by hg2ecz, 2020
#
import sys, re
...
def main() :
    if len(sys.argv) == 1: print("Forth line from stdin or read @forthfile.")
    while 1 :
...
def rRun (cod,p) : forth_execute(rDict[cod[p]]); return p+1
